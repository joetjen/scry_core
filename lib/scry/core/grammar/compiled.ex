...
defmodule Scry.Core.Grammar.Compiled do
  ...
  (
    ...
    def lex_token__IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__19(input0), {:ok, t1, rest1} <- lex_expr__22(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__POW(input0) do
      with {:ok, t0, rest0} <- lex_expr__26(input0), {:ok, t1, rest1} <- lex_expr__27(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__47(input0) do
      with {:ok, t0, rest0} <- lex_expr__48(input0),
           {:ok, t1, rest1} <- lex_expr__49(rest0),
           {:ok, t2, rest2} <- lex_expr__50(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__56(input0) do
      with {:ok, t0, rest0} <- lex_expr__57(input0),
           {:ok, t1, rest1} <- lex_expr__58(rest0),
    ...
    def lex_expr__54(input0) do
      with {:ok, t0, rest0} <- lex_expr__55(input0), {:ok, t1, rest1} <- lex_expr__60(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__51(input) do
      Tokenizer.star_char(&lex_expr__52/1, input)
    end
    ...
    def lex_expr__61(input0) do
      with {:ok, t0, rest0} <- lex_expr__62(input0),
           {:ok, t1, rest1} <- lex_expr__63(rest0),
           {:ok, t2, rest2} <- lex_expr__64(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__MULTILINE_STRING(input0) do
      with {:ok, t0, rest0} <- lex_expr__47(input0),
           {:ok, t1, rest1} <- lex_expr__51(rest0),
    ...
    def lex_token__ALNUM(input) do
      Tokenizer.first_char_match([&lex_expr__65/1, &lex_expr__66/1], input)
    end
    ...
    def lex_expr__75(input) do
      Tokenizer.not_pred_char(&lex_expr__76/1, input)
    end
    ...
    def lex_expr__74(input0) do
      with {:ok, t0, rest0} <- lex_expr__75(input0), {:ok, t1, rest1} <- lex_expr__77(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__82(input) do
      Tokenizer.first_char_match([&lex_expr__83/1, &lex_expr__84/1], input)
    end
    ...
    def lex_token__STRING(input) do
      Tokenizer.first_char_match([&lex_expr__69/1, &lex_expr__79/1], input)
    end
    ...
    def lex_expr__96(input0) do
      with {:ok, t0, rest0} <- lex_expr__97(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__99(rest1),
           {:ok, t3, rest3} <- lex_expr__100(rest2),
           {:ok, t4, rest4} <- lex_expr__101(rest3) do
    ...
    def lex_token__ESCAPE(input0) do
      with {:ok, t0, rest0} <- lex_expr__89(input0), {:ok, t1, rest1} <- lex_expr__90(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__INTEGER(input) do
      Tokenizer.plus_char(&lex_expr__102/1, input)
    end
    ...
    def lex_expr__106(input) do
      Tokenizer.not_pred_char(&lex_expr__107/1, input)
    end
    ...
    def lex_expr__105(input0) do
      with {:ok, t0, rest0} <- lex_expr__106(input0), {:ok, t1, rest1} <- lex_expr__108(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__COMMENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__103(input0), {:ok, t1, rest1} <- lex_expr__104(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__138(input0) do
      with {:ok, t0, rest0} <- lex_expr__139(input0),
           {:ok, t1, rest1} <- lex_expr__140(rest0),
           {:ok, t2, rest2} <- lex_expr__141(rest1),
           {:ok, t3, rest3} <- lex_expr__142(rest2),
           {:ok, t4, rest4} <- lex_expr__143(rest3),
           {:ok, t5, rest5} <- lex_expr__144(rest4) do
    ...
    def lex_expr__136(input) do
      Tokenizer.first_char_match([&lex_expr__137/1, &lex_expr__138/1], input)
    end
    ...
    def lex_expr__120(input0) do
      with {:ok, t0, rest0} <- lex_expr__121(input0),
           {:ok, t1, rest1} <- lex_expr__122(rest0),
           {:ok, t2, rest2} <- lex_expr__123(rest1),
           {:ok, t3, rest3} <- lex_expr__124(rest2),
           {:ok, t4, rest4} <- lex_expr__125(rest3),
           {:ok, t5, rest5} <- lex_expr__126(rest4),
           {:ok, t6, rest6} <- lex_expr__127(rest5),
           {:ok, t7, rest7} <- lex_expr__128(rest6),
           {:ok, t8, rest8} <- lex_expr__129(rest7),
           {:ok, t9, rest9} <- lex_expr__130(rest8),
           {:ok, t10, rest10} <- lex_expr__135(rest9) do
    ...
    def lex_expr__119(input) do
      Tokenizer.opt_char(&lex_expr__120/1, input)
    end

    def lex_token__DATE(input0) do
      with {:ok, t0, rest0} <- lex_expr__109(input0),
           {:ok, t1, rest1} <- lex_expr__110(rest0),
           {:ok, t2, rest2} <- lex_expr__111(rest1),
           {:ok, t3, rest3} <- lex_expr__112(rest2),
           {:ok, t4, rest4} <- lex_expr__113(rest3),
           {:ok, t5, rest5} <- lex_expr__114(rest4),
           {:ok, t6, rest6} <- lex_expr__115(rest5),
           {:ok, t7, rest7} <- lex_expr__116(rest6),
           {:ok, t8, rest8} <- lex_expr__117(rest7),
           {:ok, t9, rest9} <- lex_expr__118(rest8),
           {:ok, t10, rest10} <- lex_expr__119(rest9) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5 <> t6 <> t7 <> t8 <> t9 <> t10, rest10}
      else
        :fail -> :fail
      end
    ...
    def lex_token__LE(input0) do
      with {:ok, t0, rest0} <- lex_expr__145(input0), {:ok, t1, rest1} <- lex_expr__146(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__NOT_EQ(input0) do
      with {:ok, t0, rest0} <- lex_expr__147(input0),
           {:ok, t1, rest1} <- lex_expr__148(rest0),
           {:ok, t2, rest2} <- lex_expr__149(rest1),
           {:ok, t3, rest3} <- lex_expr__150(rest2) do
    ...
    def lex_expr__154(input) do
      Tokenizer.plus_char(&lex_expr__155/1, input)
    end

    def lex_expr__151(input0) do
      with {:ok, t0, rest0} <- lex_expr__152(input0),
    ...
    def lex_expr__164(input) do
      Tokenizer.plus_char(&lex_expr__165/1, input)
    end

    def lex_expr__161(input0) do
      with {:ok, t0, rest0} <- lex_expr__162(input0),
           {:ok, t1, rest1} <- lex_expr__163(rest0),
    ...
    def lex_token__RADIX(input) do
      Tokenizer.first_char_match([&lex_expr__151/1, &lex_expr__156/1, &lex_expr__161/1], input)
    end
    ...
    def lex_expr__169(input0) do
      with {:ok, t0, rest0} <- lex_expr__170(input0), {:ok, t1, rest1} <- lex_expr__171(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__168(input) do
      Tokenizer.opt_char(&lex_expr__169/1, input)
    end
    ...
    def lex_token__DURATION(input0) do
      with {:ok, t0, rest0} <- lex_expr__166(input0),
           {:ok, t1, rest1} <- lex_expr__168(rest0),
           {:ok, t2, rest2} <- lex_expr__173(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__185(input) do
      Tokenizer.star_char(&lex_expr__186/1, input)
    end
    ...
    def lex_token__ESCAPED_IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__181(input0),
           {:ok, t1, rest1} <- lex_expr__182(rest0),
           {:ok, t2, rest2} <- lex_expr__185(rest1),
           {:ok, t3, rest3} <- lex_expr__189(rest2) do
        {:ok, t0 <> t1 <> t2 <> t3, rest3}
      else
        :fail -> :fail
      end
    ...
    def parse_rule__type_param(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__0(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__6(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
    ...
    def parse_expr__7(stream, pos, ref_stack, context) do
      case (&parse_expr__8/4).(stream, pos, ref_stack, context) do
    ...
    def parse_rule__negation(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__7(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__12(stream, pos2, ref2, context) do
    ...
    def parse_expr__16(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__17/4, stream, pos, ref_stack, context)
    end

    def parse_rule__power(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__13(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__14(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__16(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__33(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__34(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__36(stream, pos1, ref1, context) do
    ...
    def parse_expr__32(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__33/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__disjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__22(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__23(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__25(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__64(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__65/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__62(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__63(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__64(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__41(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__69(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__71(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__72(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__74(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__77(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__78/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__80(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__81/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__76(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__77(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__79(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__80(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__82(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__83(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__84(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__85(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__87(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__88(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__90(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__95(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__96/4, stream, pos, ref_stack, context)
    end

    def parse_expr__91(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__92(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__93(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__95(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__83/4, &parse_expr__91/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__98(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__99/4, &parse_expr__100/4], stream, pos, ref_stack, context)
    end

    def parse_expr__97(stream, pos, ref_stack, context) do
      case (&parse_expr__98/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__additive_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__97(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__103(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__110(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__111/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__104(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__107(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__108(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__110(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__112(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__114(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__122(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__123(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__125(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__121(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__122/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__119(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__120(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__121(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__118(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__119/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__expression(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__115(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__116(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__118(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__when_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__126(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__133(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__135(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__136(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__138(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__141(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__142/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__144(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__145/4, stream, pos, ref_stack, context)
    end

    def parse_expr__143(stream, pos, ref_stack, context) do
      case (&parse_expr__144/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__139(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__140(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__141(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__143(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__146(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__148(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__149(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__150(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__151(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__153(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__139/4, &parse_expr__149/4, &parse_expr__154/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__166(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__167/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__combined_select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__163(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__164(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__166(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__175(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__176/4, &parse_expr__177/4], stream, pos, ref_stack, context)
    end

    def parse_expr__174(stream, pos, ref_stack, context) do
      case (&parse_expr__175/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_expr__188(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__189(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__191(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__187(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__188/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__185(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__186(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__187(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__184(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__185/4, stream, pos, ref_stack, context)
    end

    def parse_rule__type_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__181(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__182(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__184(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__192/4, &parse_expr__193/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__194(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__195(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__197(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__198(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__200(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__201(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__203(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__204(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__206(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__207(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__213(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__215(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__217(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__218(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__220(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__221(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__223(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__229(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__230(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__231(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__233(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__235(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__236(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__238(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__234(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__235/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__conjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__224(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__225(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__227(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__union_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__243(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__246(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__252(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__253(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__256(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__261(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__262(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__263(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__265(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__251(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__252(stream, pos, ref_stack, context),
    ...
    def parse_expr__250(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__251/4, stream, pos, ref_stack, context)
    end

    def parse_rule__type_field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__247(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__248(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__250(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__rational(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__266(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__269(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__270(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__272(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__273(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__274(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__276(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__277(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__279(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__280(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__282(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__286(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__287/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__298(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__299/4, stream, pos, ref_stack, context)
    end

    def parse_expr__297(stream, pos, ref_stack, context) do
      case (&parse_expr__298/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__294(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__297(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__300(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__302(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__303/4, &parse_expr__308/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__where_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__309(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__312(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__319(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__320/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__limit_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__313(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__316(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__317(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__319(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__321(stream, pos, ref_stack, context) do
      case (&parse_expr__322/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__type_operand(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__321(stream, pos, ref_stack, context),
    ...
    def parse_expr__333(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__334(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__335(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__337(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__338(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__340(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__348(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__354(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__360(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__361(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__362(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__364(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__369(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__370(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__371(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__373(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__366(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__367(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__369(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__365(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__366/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__358(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__359/4, stream, pos, ref_stack, context)
    end

    def parse_rule__order_item_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__355(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__356(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__358(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__379(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__380(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__381(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__383(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__385(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__386(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__388(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__384(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__385/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__378(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__379(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__384(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__literal_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__374(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__377(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__window_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__393(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__394(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__396(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__397(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__399(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__400(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__406(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__407(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__409(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__410(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__412(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__having_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__413(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__414(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__416(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__423(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__424/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__456(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__457/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__417(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__421(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__423(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__425(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__427(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__429(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__431(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__433(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__435(stream, pos10, ref10, context),
           {:ok, pos12, ref12, cap11} <- parse_expr__437(stream, pos11, ref11, context),
           {:ok, pos13, ref13, cap12} <- parse_expr__439(stream, pos12, ref12, context),
           {:ok, pos14, ref14, cap13} <- parse_expr__441(stream, pos13, ref13, context),
           {:ok, pos15, ref15, cap14} <- parse_expr__443(stream, pos14, ref14, context),
           {:ok, pos16, ref16, cap15} <- parse_expr__445(stream, pos15, ref15, context),
           {:ok, pos17, ref17, cap16} <- parse_expr__447(stream, pos16, ref16, context),
           {:ok, pos18, ref18, cap17} <- parse_expr__449(stream, pos17, ref17, context),
           {:ok, pos19, ref19, cap18} <- parse_expr__451(stream, pos18, ref18, context),
           {:ok, pos20, ref20, cap19} <- parse_expr__453(stream, pos19, ref19, context),
           {:ok, pos21, ref21, cap20} <- parse_expr__455(stream, pos20, ref20, context),
           {:ok, pos22, ref22, cap21} <- parse_expr__456(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__458(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__459(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__461(stream, pos24, ref24, context) do
        {:ok, pos25, ref25,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__480(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__481/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__474(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__475(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__480(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__473(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__474/4, stream, pos, ref_stack, context)
    end

    def parse_rule__path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__470(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__471(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__473(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__with_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__489/4, &parse_expr__490/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__494(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__493(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__494/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__491(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__492(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__493(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__495(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__496(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
    ...
    def parse_rule__body_list_tail(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__491/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__fragment_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__497/4, &parse_expr__498/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__506(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__507/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__504(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__505(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__506(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__508(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__516(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__515(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__516/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__513(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__514(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__515(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__517(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__510(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__511(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__513(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__509(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__510/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__503(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__504(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__509(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__502(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__503/4, stream, pos, ref_stack, context)
    end

    def parse_rule__field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__499(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__500(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__502(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__518(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__519(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__522(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__523(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__525(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__526(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__527(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__533(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__534(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__535(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__541(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__542(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__543(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__546(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__547(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__549(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__550(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__551(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__554(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__555(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__557(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__560(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__561/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__558(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__559(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__560(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__562(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__563(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__565(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__in_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__567/4, &parse_expr__568/4, &parse_expr__569/4, &parse_expr__570/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__575(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__576/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__577(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__578/4, stream, pos, ref_stack, context)
    end

    def parse_expr__573(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__574(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__575(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__577(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__571/4, &parse_expr__572/4, &parse_expr__573/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__583(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__584/4, stream, pos, ref_stack, context)
    end

    def parse_expr__586(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__585(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__586/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__over_spec(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__579(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__581(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__583(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__585(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__587(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__593(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__594/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__group_by_cube(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__589(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__592(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__593(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__595(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__596(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__598(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__604(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__605/4, &parse_expr__606/4], stream, pos, ref_stack, context)
    end

    def parse_expr__603(stream, pos, ref_stack, context) do
      case (&parse_expr__604/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__599(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__600(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__603(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__612(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__613/4, &parse_expr__614/4], stream, pos, ref_stack, context)
    end

    def parse_expr__611(stream, pos, ref_stack, context) do
      case (&parse_expr__612/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__615(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__616(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__617(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__619(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__599/4, &parse_expr__607/4, &parse_expr__615/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__625(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__626/4, stream, pos, ref_stack, context)
    end

    def parse_expr__624(stream, pos, ref_stack, context) do
      case (&parse_expr__625/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__body_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__620(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__622(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__624(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(cap1, Parser.merge_captures(cap2, cap3))
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__627(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__630(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__631(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__633(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__650/4, &parse_expr__651/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__partition_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__652(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__653(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__655(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__656(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__658(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__when_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__659(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__660(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__662(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__663(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__665(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__666(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__668(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__676(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__677/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__674(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__675(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__676(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__678(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__681(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__682/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__685(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__686/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__683(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__684(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__685(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__687(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__680(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__681(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__683(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__679(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__680/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__673(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__674(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__679(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__672(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__673/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__669(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__670(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__672(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__688/4, &parse_expr__689/4, &parse_expr__690/4, &parse_expr__691/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__693(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__694/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__shape_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__692(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__693(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__695(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__696(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__698(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__predicate_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__699/4, &parse_expr__700/4, &parse_expr__701/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__707(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__708/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__711(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__712/4, &parse_expr__713/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__709(stream, pos, ref_stack, context) do
      case (&parse_expr__710/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__order_item(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__706(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__707(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__709(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__720(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__721/4, &parse_expr__722/4, &parse_expr__723/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__group_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__714(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__715(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__717(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__718(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__720(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__731(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__732/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__724(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__725(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__727(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__728(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__730(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__731(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__733(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__739(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__738(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__739/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__list_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__734(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__735(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__737(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__738(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__740(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
