  ...
  (
    ...
    def lex_token__NOT_EQ(input0) do
      with {:ok, t0, rest0} <- lex_expr__2(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__4(rest1),
           {:ok, t3, rest3} <- lex_expr__5(rest2) do
    ...
    def lex_expr__22(input) do
      Tokenizer.not_pred_char(&lex_expr__23/1, input)
    end
    ...
    def lex_expr__21(input0) do
      with {:ok, t0, rest0} <- lex_expr__22(input0), {:ok, t1, rest1} <- lex_expr__24(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__16(input0) do
      with {:ok, t0, rest0} <- lex_expr__17(input0),
           {:ok, t1, rest1} <- lex_expr__18(rest0),
           {:ok, t2, rest2} <- lex_expr__25(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__STRING(input) do
      Tokenizer.first_char_match([&lex_expr__6/1, &lex_expr__16/1], input)
    end
    ...
    def lex_expr__26(input0) do
      with {:ok, t0, rest0} <- lex_expr__27(input0),
           {:ok, t1, rest1} <- lex_expr__28(rest0),
           {:ok, t2, rest2} <- lex_expr__29(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__35(input0) do
      with {:ok, t0, rest0} <- lex_expr__36(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__38(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__34(input) do
      Tokenizer.not_pred_char(&lex_expr__35/1, input)
    end
    ...
    def lex_expr__33(input0) do
      with {:ok, t0, rest0} <- lex_expr__34(input0), {:ok, t1, rest1} <- lex_expr__39(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__MULTILINE_STRING(input0) do
      with {:ok, t0, rest0} <- lex_expr__26(input0),
    ...
    def lex_token__POW(input0) do
      with {:ok, t0, rest0} <- lex_expr__44(input0), {:ok, t1, rest1} <- lex_expr__45(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__49(input) do
      Tokenizer.not_pred_char(&lex_expr__50/1, input)
    end
    ...
    def lex_expr__48(input0) do
      with {:ok, t0, rest0} <- lex_expr__49(input0), {:ok, t1, rest1} <- lex_expr__51(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__47(input) do
      Tokenizer.star_char(&lex_expr__48/1, input)
    end

    def lex_token__COMMENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__46(input0), {:ok, t1, rest1} <- lex_expr__47(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__54(input) do
      Tokenizer.plus_char(&lex_expr__55/1, input)
    end
    ...
    def lex_expr__57(input) do
      Tokenizer.plus_char(&lex_expr__58/1, input)
    end

    def lex_token__DECIMAL(input0) do
      with {:ok, t0, rest0} <- lex_expr__54(input0),
           {:ok, t1, rest1} <- lex_expr__56(rest0),
           {:ok, t2, rest2} <- lex_expr__57(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__59(input) do
      Tokenizer.plus_char(&lex_expr__60/1, input)
    end
    ...
    def lex_expr__64(input) do
      Tokenizer.plus_char(&lex_expr__65/1, input)
    end
    ...
    def lex_expr__75(input) do
      Tokenizer.first_char_match([&lex_expr__76/1, &lex_expr__77/1], input)
    end
    ...
    def lex_expr__78(input) do
      Tokenizer.star_char(&lex_expr__79/1, input)
    end
    ...
    def lex_expr__95(input) do
      Tokenizer.first_char_match([&lex_expr__96/1, &lex_expr__97/1], input)
    end

    def lex_token__TRIVIA(input) do
      Tokenizer.star_char(&lex_expr__95/1, input)
    end
    ...
    def lex_expr__103(input) do
      Tokenizer.first_char_match([&lex_expr__104/1, &lex_expr__105/1], input)
    end

    def lex_expr__102(input) do
      Tokenizer.star_char(&lex_expr__103/1, input)
    end

    def lex_token__ATOM(input0) do
      with {:ok, t0, rest0} <- lex_expr__98(input0),
           {:ok, t1, rest1} <- lex_expr__99(rest0),
    ...
    def lex_expr__109(input) do
      Tokenizer.plus_char(&lex_expr__110/1, input)
    end

    def lex_expr__106(input0) do
      with {:ok, t0, rest0} <- lex_expr__107(input0),
           {:ok, t1, rest1} <- lex_expr__108(rest0),
    ...
    def lex_expr__114(input) do
      Tokenizer.plus_char(&lex_expr__115/1, input)
    end
    ...
    def lex_expr__119(input) do
      Tokenizer.plus_char(&lex_expr__120/1, input)
    end
    ...
    def lex_token__RADIX(input) do
      Tokenizer.first_char_match([&lex_expr__106/1, &lex_expr__111/1, &lex_expr__116/1], input)
    end
    ...
    def lex_token__GE(input0) do
      with {:ok, t0, rest0} <- lex_expr__124(input0), {:ok, t1, rest1} <- lex_expr__125(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__126(input) do
      Tokenizer.plus_char(&lex_expr__127/1, input)
    end
    ...
    def lex_expr__131(input) do
      Tokenizer.plus_char(&lex_expr__132/1, input)
    end
    ...
    def lex_expr__128(input) do
      Tokenizer.opt_char(&lex_expr__129/1, input)
    end
    ...
    def lex_token__INTEGER(input) do
      Tokenizer.plus_char(&lex_expr__145/1, input)
    end
    ...
    def lex_expr__168(input0) do
      with {:ok, t0, rest0} <- lex_expr__169(input0), {:ok, t1, rest1} <- lex_expr__170(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__167(input) do
      Tokenizer.opt_char(&lex_expr__168/1, input)
    end
    ...
    def lex_expr__175(input0) do
      with {:ok, t0, rest0} <- lex_expr__176(input0),
           {:ok, t1, rest1} <- lex_expr__177(rest0),
           {:ok, t2, rest2} <- lex_expr__178(rest1),
           {:ok, t3, rest3} <- lex_expr__179(rest2),
           {:ok, t4, rest4} <- lex_expr__180(rest3),
           {:ok, t5, rest5} <- lex_expr__181(rest4) do
    ...
    def lex_expr__172(input) do
      Tokenizer.opt_char(&lex_expr__173/1, input)
    end

    def lex_expr__157(input0) do
      with {:ok, t0, rest0} <- lex_expr__158(input0),
           {:ok, t1, rest1} <- lex_expr__159(rest0),
           {:ok, t2, rest2} <- lex_expr__160(rest1),
           {:ok, t3, rest3} <- lex_expr__161(rest2),
           {:ok, t4, rest4} <- lex_expr__162(rest3),
           {:ok, t5, rest5} <- lex_expr__163(rest4),
           {:ok, t6, rest6} <- lex_expr__164(rest5),
           {:ok, t7, rest7} <- lex_expr__165(rest6),
           {:ok, t8, rest8} <- lex_expr__166(rest7),
           {:ok, t9, rest9} <- lex_expr__167(rest8),
           {:ok, t10, rest10} <- lex_expr__172(rest9) do
    ...
    def lex_expr__156(input) do
      Tokenizer.opt_char(&lex_expr__157/1, input)
    end
    ...
    def lex_token__DATE(input0) do
      with {:ok, t0, rest0} <- lex_expr__146(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__149(rest2),
           {:ok, t4, rest4} <- lex_expr__150(rest3),
           {:ok, t5, rest5} <- lex_expr__151(rest4),
           {:ok, t6, rest6} <- lex_expr__152(rest5),
           {:ok, t7, rest7} <- lex_expr__153(rest6),
           {:ok, t8, rest8} <- lex_expr__154(rest7),
           {:ok, t9, rest9} <- lex_expr__155(rest8),
           {:ok, t10, rest10} <- lex_expr__156(rest9) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5 <> t6 <> t7 <> t8 <> t9 <> t10, rest10}
      else
        :fail -> :fail
      end
    ...
    def lex_token__IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__182(input0), {:ok, t1, rest1} <- lex_expr__185(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__0/4, &parse_expr__1/4, &parse_expr__2/4, &parse_expr__3/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__offset_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__4(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__7(stream, pos2, ref2, context) do
    ...
    def parse_rule__negation(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__8(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__13(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__14(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__15(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__18(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__19(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__21(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
    ...
    def parse_expr__22(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__23(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__26(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__27(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__29(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__30(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__31(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__34(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__35(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__37(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__70(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__71(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__73(stream, pos1, ref1, context) do
    ...
    def parse_expr__69(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__70/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__67(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__68(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__69(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__66(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__67/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__63(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__66(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__74(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__81(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__83(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__84(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__86(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__93(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__94/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__87(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__90(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__91(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__93(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__95(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__97(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__98(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__100(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__101(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__103(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__120(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__121/4, &parse_expr__122/4], stream, pos, ref_stack, context)
    end

    def parse_expr__119(stream, pos, ref_stack, context) do
      case (&parse_expr__120/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__128(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__129/4, &parse_expr__130/4], stream, pos, ref_stack, context)
    end

    def parse_expr__127(stream, pos, ref_stack, context) do
      case (&parse_expr__128/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__123(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__124(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__127(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__131(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__132(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__135(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__115/4, &parse_expr__123/4, &parse_expr__131/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__union_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__140(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__143(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__168(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__169(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__170(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__172(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__174(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__175(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__177(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__173(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__174/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__193(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__199(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__200(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__202(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__203(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__206(stream, pos2, ref2, context),
    ...
    def parse_rule__having_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__210(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__213(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__218(stream, pos, ref_stack, context) do
      case (&parse_expr__219/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__214/4, &parse_expr__224/4, &parse_expr__229/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__241(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__242(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__244(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__240(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__241/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__multiplicative(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__234(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__237(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__256(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__257/4, stream, pos, ref_stack, context)
    end

    def parse_expr__255(stream, pos, ref_stack, context) do
      case (&parse_expr__256/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__252(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__253(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__255(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__258(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__260(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__261(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__267(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__partition_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__268(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__269(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__271(stream, pos2, ref2, context),
    ...
    def parse_expr__282(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__283/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__280(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__281(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__282(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__284(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__289(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__290(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__293(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__285(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__286/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__279(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__280(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__285(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__278(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__279/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__disjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__275(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__276(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__278(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__301(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__302/4, &parse_expr__303/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__299(stream, pos, ref_stack, context) do
      case (&parse_expr__300/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__order_item(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__296(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__297(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__299(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__308/4, &parse_expr__309/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__316(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__317(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__320(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__321(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__323(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__333(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__334/4, &parse_expr__335/4], stream, pos, ref_stack, context)
    end

    def parse_expr__332(stream, pos, ref_stack, context) do
      case (&parse_expr__333/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__unary(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__331/4, &parse_expr__339/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_param(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__340(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__343(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__344(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__346(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__347(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__350(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__351(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__353(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__354(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__356(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__357(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__359(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__361(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__362/4, &parse_expr__363/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__373(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__374/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__371(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__372(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__373(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__379(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__380/4, &parse_expr__381/4], stream, pos, ref_stack, context)
    end

    def parse_expr__378(stream, pos, ref_stack, context) do
      case (&parse_expr__379/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__when_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__385(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__392(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__394(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__401(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__402/4, &parse_expr__403/4, &parse_expr__404/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__group_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__395(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__398(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__399(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__401(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__405(stream, pos, ref_stack, context) do
      case (&parse_expr__406/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__411/4, &parse_expr__412/4, &parse_expr__413/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__419(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__425(stream, pos4, ref4, context),
           ...
           {:ok, pos9, ref9, cap8} <- parse_expr__433(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__435(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__437(stream, pos10, ref10, context),
           {:ok, pos12, ref12, cap11} <- parse_expr__439(stream, pos11, ref11, context),
           {:ok, pos13, ref13, cap12} <- parse_expr__441(stream, pos12, ref12, context),
           {:ok, pos14, ref14, cap13} <- parse_expr__443(stream, pos13, ref13, context),
           {:ok, pos15, ref15, cap14} <- parse_expr__445(stream, pos14, ref14, context),
           {:ok, pos16, ref16, cap15} <- parse_expr__447(stream, pos15, ref15, context),
           {:ok, pos17, ref17, cap16} <- parse_expr__449(stream, pos16, ref16, context),
           {:ok, pos18, ref18, cap17} <- parse_expr__451(stream, pos17, ref17, context),
           {:ok, pos19, ref19, cap18} <- parse_expr__453(stream, pos18, ref18, context),
           {:ok, pos20, ref20, cap19} <- parse_expr__455(stream, pos19, ref19, context),
           {:ok, pos21, ref21, cap20} <- parse_expr__457(stream, pos20, ref20, context),
           {:ok, pos22, ref22, cap21} <- parse_expr__459(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__461(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__462(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__464(stream, pos24, ref24, context),
           {:ok, pos26, ref26, cap25} <- parse_expr__465(stream, pos25, ref25, context),
           {:ok, pos27, ref27, cap26} <- parse_expr__467(stream, pos26, ref26, context) do
        {:ok, pos27, ref27,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__482(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__483(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__485(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__481(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__482/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__478(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__479/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__491(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__492/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__489(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__490(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__491(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__499(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__500/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__501(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__502/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__468(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__486(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__488(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__496(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__498(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__499(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__501(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__507(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__508/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__rational(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__503(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__504(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__506(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__507(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__509(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__522(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__523/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__527(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__526(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__527/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__524(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__525(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__526(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__528(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__521(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__522(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__524(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__520(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__521/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__514(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__515(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__520(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__513(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__514/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__529/4, &parse_expr__534/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_kind(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__552(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__555(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__shape_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__556(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__559(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__560(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__562(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__577(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__578(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__579(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__581(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__574(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__575(stream, pos, ref_stack, context),
    ...
    def parse_expr__573(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__574/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__567(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__568(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__573(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__566(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__567/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__conjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__563(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__564(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__566(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__window_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__582(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__585(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__586(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__588(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__603(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__604(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__605(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__607(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__599(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__600/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__593(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__594(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__599(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__in_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__608/4, &parse_expr__609/4, &parse_expr__610/4, &parse_expr__611/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__613(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__614/4, &parse_expr__615/4], stream, pos, ref_stack, context)
    end

    def parse_expr__612(stream, pos, ref_stack, context) do
      case (&parse_expr__613/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__mult_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__612(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__618(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__623(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__624(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__625(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__627(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__622(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__623/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__628(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__629(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__635(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__640(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__641/4, stream, pos, ref_stack, context)
    end

    def parse_expr__636(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__637(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__638(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__640(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__628/4, &parse_expr__636/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__662(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__663/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__limit_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__658(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__661(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__662(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__664(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__671(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__672(stream, pos, ref_stack, context),
    ...
    def parse_expr__669(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__670/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__685(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__691(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__692(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__694(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__711(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__712/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__709(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__710(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__711(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__713(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__706(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__707(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__709(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__705(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__706/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__699(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__700(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__705(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__698(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__699/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__695(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__698(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__714/4, &parse_expr__715/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__716(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__717/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__720(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__721/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__over_spec(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__716(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__720(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__722(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__724(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__predicate_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__726/4, &parse_expr__727/4, &parse_expr__728/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__740(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__741(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__743(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__739(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__740/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__737(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__738(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__739(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__736(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__737/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__746(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__747/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__749(stream, pos, ref_stack, context) do
    ...
    def parse_expr__744(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__745(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__746(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__748(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__749(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
    ...
    def parse_rule__body_list_tail(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__744/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__goal_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__750(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__751(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__753(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__755(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__757(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__765(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__766/4, stream, pos, ref_stack, context)
    end

    def parse_expr__764(stream, pos, ref_stack, context) do
      case (&parse_expr__765/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__body_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__760(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__764(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(cap1, Parser.merge_captures(cap2, cap3))
    ...
    def parse_expr__770(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__771(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__773(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__769(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__770/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__767(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__768(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__769(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__when_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__767(stream, pos, ref_stack, context),
