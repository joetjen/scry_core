...
defmodule Scry.Core.Grammar.Compiled do
  ...
  (
    ...
    def parse_expr__13(stream, pos, ref_stack, context) do
      case (&parse_expr__14/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__28(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__29(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__31(stream, pos1, ref1, context) do
    ...
    def parse_expr__27(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__28/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__24(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__25/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__34(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__35/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__47(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__48/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__45(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__46(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__47(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__44(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__45/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__24(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__42(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__44(stream, pos4, ref4, context),
    ...
    def parse_rule__in_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__59/4, &parse_expr__60/4, &parse_expr__61/4, &parse_expr__62/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__78(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__84(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__86(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__88(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__94(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__95/4, &parse_expr__96/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__92(stream, pos, ref_stack, context) do
      case (&parse_expr__93/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__order_item(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__89(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__90(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__92(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__109(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__110/4, stream, pos, ref_stack, context)
    end

    def parse_expr__108(stream, pos, ref_stack, context) do
      case (&parse_expr__109/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__104(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__105(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__111(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__113(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__104/4, &parse_expr__114/4, &parse_expr__119/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__135(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__136(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__138(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__134(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__135/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__combined_select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__128(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__131(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__power(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__139(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__142(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__167/4, &parse_expr__168/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__169(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__172(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__173(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__175(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__176(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__178(stream, pos6, ref6, context),
    ...
    def parse_rule__type_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__189(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__190(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__192(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__193(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__195(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__197(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__199(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__200(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__202(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__203(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__205(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__220(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__221(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__224(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__210(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__211(stream, pos, ref_stack, context),
    ...
    def parse_expr__209(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__210/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__229(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__230(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__233(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__234(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
    ...
    def parse_expr__246(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__247(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__249(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__245(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__246/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__239(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__240(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__245(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__238(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__239/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__259(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__260(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__263(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__265(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__266(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__268(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__264(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__265/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__258(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__259(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__264(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__257(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__258/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__having_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__273(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__276(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__when_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__286(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__295(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__296(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__298(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__299(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__300(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__301(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__303(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__299/4, &parse_expr__304/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__305(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__306(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__308(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__309(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__311(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__313(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__314/4, stream, pos, ref_stack, context)
    end

    def parse_expr__312(stream, pos, ref_stack, context) do
      case (&parse_expr__313/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__324(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__325(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__326(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__328(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__329(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__331(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__357(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__358(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__360(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__356(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__357/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__350(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__351(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__356(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__346(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__347(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__349(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__goal_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__365(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__372(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__374(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__375/4, &parse_expr__376/4], stream, pos, ref_stack, context)
    end

    def parse_expr__373(stream, pos, ref_stack, context) do
      case (&parse_expr__374/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__partition_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__380(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__383(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__384(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__386(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__393(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__394/4, &parse_expr__395/4, &parse_expr__396/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__group_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__387(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__390(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__391(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__393(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__397(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__400(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__401(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__403(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__405(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__407(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__409(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__411(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__413(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__415(stream, pos10, ref10, context),
           {:ok, pos12, ref12, cap11} <- parse_expr__417(stream, pos11, ref11, context),
           {:ok, pos13, ref13, cap12} <- parse_expr__419(stream, pos12, ref12, context),
           {:ok, pos14, ref14, cap13} <- parse_expr__421(stream, pos13, ref13, context),
           {:ok, pos15, ref15, cap14} <- parse_expr__423(stream, pos14, ref14, context),
           {:ok, pos16, ref16, cap15} <- parse_expr__425(stream, pos15, ref15, context),
           {:ok, pos17, ref17, cap16} <- parse_expr__427(stream, pos16, ref16, context),
           {:ok, pos18, ref18, cap17} <- parse_expr__429(stream, pos17, ref17, context),
           {:ok, pos19, ref19, cap18} <- parse_expr__431(stream, pos18, ref18, context),
           {:ok, pos20, ref20, cap19} <- parse_expr__433(stream, pos19, ref19, context),
           {:ok, pos21, ref21, cap20} <- parse_expr__435(stream, pos20, ref20, context),
           {:ok, pos22, ref22, cap21} <- parse_expr__437(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__439(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__440(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__442(stream, pos24, ref24, context),
           {:ok, pos26, ref26, cap25} <- parse_expr__443(stream, pos25, ref25, context),
           {:ok, pos27, ref27, cap26} <- parse_expr__445(stream, pos26, ref26, context) do
        {:ok, pos27, ref27,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__446/4, &parse_expr__447/4, &parse_expr__448/4, &parse_expr__449/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__464(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__465(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__466(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__468(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__461(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__462(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__464(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__460(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__461/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__454(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__455(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__460(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__conjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__450(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__453(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__type_kind(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__469(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__472(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__predicate_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__473/4, &parse_expr__474/4, &parse_expr__475/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__488(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__489/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__487(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__488(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__490(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__486(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__487/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__480(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__481(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__486(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__with_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__495/4, &parse_expr__496/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__fragment_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__504/4, &parse_expr__505/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__group_by_cube(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__506(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__507(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__509(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__510(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__512(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__513(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__515(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__when_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__516(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__519(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__520(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__522(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__523(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__525(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__532(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__533/4, stream, pos, ref_stack, context)
    end

    def parse_expr__528(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__529(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__530(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__532(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__526/4, &parse_expr__527/4, &parse_expr__528/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__534(stream, pos, ref_stack, context),
           ...
           {:ok, pos7, ref7, cap6} <- parse_expr__543(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__544(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__547(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__548(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__550(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__551(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__553(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__554(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__556(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__562(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__563/4, stream, pos, ref_stack, context)
    end

    def parse_expr__561(stream, pos, ref_stack, context) do
      case (&parse_expr__562/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__body_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__557(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__561(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(cap1, Parser.merge_captures(cap2, cap3))
    ...
    def parse_expr__585(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__586/4, &parse_expr__587/4], stream, pos, ref_stack, context)
    end

    def parse_expr__584(stream, pos, ref_stack, context) do
      case (&parse_expr__585/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__580(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__581(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__584(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__593(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__594/4, &parse_expr__595/4], stream, pos, ref_stack, context)
    end

    def parse_expr__592(stream, pos, ref_stack, context) do
      case (&parse_expr__593/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__598(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__599/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__596(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__597(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__598(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__600(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__580/4, &parse_expr__588/4, &parse_expr__596/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__601/4, &parse_expr__602/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__628(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :RBRACE) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, RBRACE: {:token, :RBRACE, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, RBRACE: capture}
        :fail -> :fail
    ...
    def parse_expr__637(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__638/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__over_spec(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__629(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__633(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__635(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__637(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__652(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__653/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__647(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__648(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__652(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__654(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__655(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__656(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__659(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__660(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__662(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__663(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__664(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__670(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__671(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__672(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__675(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__676(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__678(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__679(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__680(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__681(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__683(stream, pos2, ref2, context),
    ...
    def parse_expr__704(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__705(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__706(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__708(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__713(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__714(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__717(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__709(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__710/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__703(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__704(stream, pos, ref_stack, context),
    ...
    def parse_expr__702(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__703/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__order_item_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__699(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__702(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__722(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__723(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__725(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__726(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__728(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__729(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__731(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__732(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__733(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__736(stream, pos2, ref2, context),
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__732/4, &parse_expr__740/4], stream, pos, ref_stack, context)
    end
