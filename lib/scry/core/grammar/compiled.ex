  ...
  (
    ...
    def lex_token__SPREAD(input0) do
      with {:ok, t0, rest0} <- lex_expr__19(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__21(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__48(input) do
      Tokenizer.plus_char(&lex_expr__49/1, input)
    end
    ...
    def lex_expr__45(input) do
      Tokenizer.opt_char(&lex_expr__46/1, input)
    end
    ...
    def lex_expr__53(input0) do
      with {:ok, t0, rest0} <- lex_expr__54(input0),
           {:ok, t1, rest1} <- lex_expr__55(rest0),
           {:ok, t2, rest2} <- lex_expr__56(rest1),
           {:ok, t3, rest3} <- lex_expr__57(rest2),
           {:ok, t4, rest4} <- lex_expr__58(rest3),
           {:ok, t5, rest5} <- lex_expr__59(rest4) do
    ...
    def lex_expr__51(input) do
      Tokenizer.first_char_match([&lex_expr__52/1, &lex_expr__53/1], input)
    end

    def lex_expr__50(input) do
      Tokenizer.opt_char(&lex_expr__51/1, input)
    end

    def lex_expr__35(input0) do
      with {:ok, t0, rest0} <- lex_expr__36(input0),
           {:ok, t1, rest1} <- lex_expr__37(rest0),
           {:ok, t2, rest2} <- lex_expr__38(rest1),
           {:ok, t3, rest3} <- lex_expr__39(rest2),
           {:ok, t4, rest4} <- lex_expr__40(rest3),
           {:ok, t5, rest5} <- lex_expr__41(rest4),
           {:ok, t6, rest6} <- lex_expr__42(rest5),
           {:ok, t7, rest7} <- lex_expr__43(rest6),
           {:ok, t8, rest8} <- lex_expr__44(rest7),
           {:ok, t9, rest9} <- lex_expr__45(rest8),
           {:ok, t10, rest10} <- lex_expr__50(rest9) do
    ...
    def lex_expr__34(input) do
      Tokenizer.opt_char(&lex_expr__35/1, input)
    end
    ...
    def lex_token__DATE(input0) do
      with {:ok, t0, rest0} <- lex_expr__24(input0),
           ...
           {:ok, t10, rest10} <- lex_expr__34(rest9) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5 <> t6 <> t7 <> t8 <> t9 <> t10, rest10}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__63(input) do
      Tokenizer.plus_char(&lex_expr__64/1, input)
    end
    ...
    def lex_expr__68(input) do
      Tokenizer.plus_char(&lex_expr__69/1, input)
    end

    def lex_expr__65(input0) do
    ...
    def lex_expr__70(input0) do
      with {:ok, t0, rest0} <- lex_expr__71(input0),
           {:ok, t1, rest1} <- lex_expr__72(rest0),
    ...
    def lex_token__RADIX(input) do
      Tokenizer.first_char_match([&lex_expr__60/1, &lex_expr__65/1, &lex_expr__70/1], input)
    end
    ...
    def lex_expr__75(input) do
      Tokenizer.plus_char(&lex_expr__76/1, input)
    end
    ...
    def lex_token__DECIMAL(input0) do
      with {:ok, t0, rest0} <- lex_expr__75(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__78(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__84(input) do
      Tokenizer.not_pred_char(&lex_expr__85/1, input)
    end
    ...
    def lex_expr__83(input0) do
      with {:ok, t0, rest0} <- lex_expr__84(input0), {:ok, t1, rest1} <- lex_expr__86(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__82(input) do
      Tokenizer.star_char(&lex_expr__83/1, input)
    end
    ...
    def lex_expr__87(input) do
      Tokenizer.plus_char(&lex_expr__88/1, input)
    end
    ...
    def lex_expr__90(input0) do
      with {:ok, t0, rest0} <- lex_expr__91(input0), {:ok, t1, rest1} <- lex_expr__92(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__89(input) do
      Tokenizer.opt_char(&lex_expr__90/1, input)
    end
    ...
    def lex_token__DURATION(input0) do
      with {:ok, t0, rest0} <- lex_expr__87(input0),
           {:ok, t1, rest1} <- lex_expr__89(rest0),
           {:ok, t2, rest2} <- lex_expr__94(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__102(input0) do
      with {:ok, t0, rest0} <- lex_expr__103(input0),
    ...
    def lex_expr__111(input0) do
      with {:ok, t0, rest0} <- lex_expr__112(input0),
           {:ok, t1, rest1} <- lex_expr__113(rest0),
           {:ok, t2, rest2} <- lex_expr__114(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__110(input) do
      Tokenizer.not_pred_char(&lex_expr__111/1, input)
    end
    ...
    def lex_expr__109(input0) do
      with {:ok, t0, rest0} <- lex_expr__110(input0), {:ok, t1, rest1} <- lex_expr__115(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__107(input) do
      Tokenizer.first_char_match([&lex_expr__108/1, &lex_expr__109/1], input)
    end

    def lex_expr__106(input) do
      Tokenizer.star_char(&lex_expr__107/1, input)
    end
    ...
    def lex_token__MULTILINE_STRING(input0) do
      with {:ok, t0, rest0} <- lex_expr__102(input0),
           {:ok, t1, rest1} <- lex_expr__106(rest0),
    ...
    def lex_expr__129(input0) do
      with {:ok, t0, rest0} <- lex_expr__130(input0),
           {:ok, t1, rest1} <- lex_expr__131(rest0),
           {:ok, t2, rest2} <- lex_expr__132(rest1),
           {:ok, t3, rest3} <- lex_expr__133(rest2),
           {:ok, t4, rest4} <- lex_expr__134(rest3) do
    ...
    def lex_expr__141(input) do
      Tokenizer.not_pred_char(&lex_expr__142/1, input)
    end
    ...
    def lex_expr__140(input0) do
      with {:ok, t0, rest0} <- lex_expr__141(input0), {:ok, t1, rest1} <- lex_expr__143(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__138(input) do
      Tokenizer.first_char_match([&lex_expr__139/1, &lex_expr__140/1], input)
    end
    ...
    def lex_token__STRING(input) do
      Tokenizer.first_char_match([&lex_expr__135/1, &lex_expr__145/1], input)
    end
    ...
    def lex_expr__162(input) do
      Tokenizer.first_char_match([&lex_expr__163/1, &lex_expr__164/1], input)
    end

    def lex_expr__161(input) do
      Tokenizer.star_char(&lex_expr__162/1, input)
    end
    ...
    def lex_token__ESCAPED_IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__157(input0),
           {:ok, t1, rest1} <- lex_expr__158(rest0),
           {:ok, t2, rest2} <- lex_expr__161(rest1),
           {:ok, t3, rest3} <- lex_expr__165(rest2) do
    ...
    def lex_token__GE(input0) do
      with {:ok, t0, rest0} <- lex_expr__166(input0), {:ok, t1, rest1} <- lex_expr__167(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__NOT_EQ(input0) do
      with {:ok, t0, rest0} <- lex_expr__168(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__171(rest2) do
        {:ok, t0 <> t1 <> t2 <> t3, rest3}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__175(input) do
      Tokenizer.first_char_match([&lex_expr__176/1, &lex_expr__177/1], input)
    end
    ...
    def lex_expr__179(input) do
      Tokenizer.first_char_match([&lex_expr__180/1, &lex_expr__181/1], input)
    end

    def lex_expr__178(input) do
      Tokenizer.star_char(&lex_expr__179/1, input)
    end

    def lex_token__IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__175(input0), {:ok, t1, rest1} <- lex_expr__178(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__183(input) do
      Tokenizer.first_char_match([&lex_expr__184/1, &lex_expr__185/1], input)
    end
    ...
    def lex_expr__187(input) do
      Tokenizer.first_char_match([&lex_expr__188/1, &lex_expr__189/1], input)
    end

    def lex_expr__186(input) do
      Tokenizer.star_char(&lex_expr__187/1, input)
    end

    def lex_token__ATOM(input0) do
      with {:ok, t0, rest0} <- lex_expr__182(input0),
    ...
    def lex_expr__191(input) do
      Tokenizer.first_char_match([&lex_expr__192/1, &lex_expr__193/1], input)
    end
    ...
    def parse_expr__7(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__8(stream, pos, ref_stack, context),
    ...
    def parse_expr__6(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__7/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__4(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__5(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__6(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__11(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__17(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__18(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__20(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__21(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__23(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
    ...
    def parse_rule__call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__32(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__36(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__38(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__40(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__42(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__46(stream, pos, ref_stack, context) do
      case (&parse_expr__47/4).(stream, pos, ref_stack, context) do
    ...
    def parse_expr__55(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__56/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__43(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__44(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__46(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__49(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__51(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__52(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__54(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__55(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__57(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__63(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__64(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__67(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__72(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__73(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__74(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__76(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__69(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__70(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__72(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__68(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__69/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__62(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__63(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__68(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__81(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__82(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__83(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__85(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__90(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__91(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__93(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__94(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__96(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__97(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__99(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__100(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__102(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__104(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__105/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__108(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__109(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__112(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__114(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__115(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__117(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__113(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__114/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__107(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__108(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__113(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__106(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__107/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__literal_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__103(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__104(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__106(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__124(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__125/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__122(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__123(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__124(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__when_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__122(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__129(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__131(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__132(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__134(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__135/4, &parse_expr__140/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__147(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__148/4, stream, pos, ref_stack, context)
    end

    def parse_rule__limit_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__141(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__142(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__144(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__145(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__147(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__shape_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__149(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__155(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__180(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__181/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__178(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__179(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__180(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__182(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__175(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__176(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__178(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__174(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__175/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__168(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__169(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__174(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__167(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__168/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__disjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__164(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__165(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__167(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__193(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__194(stream, pos, ref_stack, context),
    ...
    def parse_expr__192(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__193/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__mult_lhs(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__183(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__184(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__186(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__187(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__189(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__197/4, &parse_expr__198/4, &parse_expr__199/4, &parse_expr__200/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__rational(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__201(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__204(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__205(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__207(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__221(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__222/4, &parse_expr__223/4, &parse_expr__224/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__group_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__215(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__221(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__229(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__230/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__231(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__232/4, stream, pos, ref_stack, context)
    end

    def parse_expr__227(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__228(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__229(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__231(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__225/4, &parse_expr__226/4, &parse_expr__227/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__243(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__244/4, stream, pos, ref_stack, context)
    end

    def parse_expr__233(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__234(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__235(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__237(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__238(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__240(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__241(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__243(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__249(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__250/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__245(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__246(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__249(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__233/4, &parse_expr__245/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__254(stream, pos, ref_stack, context) do
      case (&parse_expr__255/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__superset_or_eq_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__260(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__261(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__263(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__264(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__266(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__267(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__269(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__270/4, &parse_expr__271/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__279(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__280(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__282(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__278(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__279/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__window_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__283(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__289(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__group_by_cube(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__290(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__291(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__293(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__294(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__296(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__297(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__299(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__302(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__303/4, &parse_expr__304/4], stream, pos, ref_stack, context)
    end

    def parse_expr__301(stream, pos, ref_stack, context) do
      case (&parse_expr__302/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__unary(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__300/4, &parse_expr__308/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__317(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__318(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__319(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__321(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__322(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__324(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__342(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__343/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__340(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__341(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__342(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__344(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__345(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__347(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__348(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__349(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__352(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__353(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__355(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__356(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__357(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__363(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__364(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__365(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__371(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__372(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__373(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__379(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__380(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__381(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__387(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__389(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__390(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__394(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
    ...
    def parse_rule__union_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__395(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__396(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__398(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__399(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__400(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__402(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__403(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__405(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__406(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__408(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__414(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__415/4, stream, pos, ref_stack, context)
    end

    def parse_expr__413(stream, pos, ref_stack, context) do
      case (&parse_expr__414/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__409(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__410(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__413(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__416(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__418(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__424(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__425(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__428(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__409/4, &parse_expr__419/4, &parse_expr__424/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__over_spec(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__429(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__431(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__433(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__435(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__437(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__440(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__441/4, &parse_expr__442/4], stream, pos, ref_stack, context)
    end

    def parse_expr__439(stream, pos, ref_stack, context) do
      case (&parse_expr__440/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__bitwise_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__439(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__443(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__445(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__goal_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__446(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__449(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__451(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__453(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__476(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__477/4, stream, pos, ref_stack, context)
    end

    def parse_expr__479(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__478(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__479/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__480(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__481/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__482(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__483/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__484(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__485/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__494(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__495/4, stream, pos, ref_stack, context)
    end

    def parse_expr__496(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :LBRACE) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, LBRACE: {:token, :LBRACE, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, LBRACE: capture}
        :fail -> :fail
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__454(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__455(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__457(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__458(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__460(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__462(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__464(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__466(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__468(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__470(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__472(stream, pos10, ref10, context),
           {:ok, pos12, ref12, cap11} <- parse_expr__474(stream, pos11, ref11, context),
           {:ok, pos13, ref13, cap12} <- parse_expr__476(stream, pos12, ref12, context),
           {:ok, pos14, ref14, cap13} <- parse_expr__478(stream, pos13, ref13, context),
           {:ok, pos15, ref15, cap14} <- parse_expr__480(stream, pos14, ref14, context),
           {:ok, pos16, ref16, cap15} <- parse_expr__482(stream, pos15, ref15, context),
           {:ok, pos17, ref17, cap16} <- parse_expr__484(stream, pos16, ref16, context),
           {:ok, pos18, ref18, cap17} <- parse_expr__486(stream, pos17, ref17, context),
           {:ok, pos19, ref19, cap18} <- parse_expr__488(stream, pos18, ref18, context),
           {:ok, pos20, ref20, cap19} <- parse_expr__490(stream, pos19, ref19, context),
           {:ok, pos21, ref21, cap20} <- parse_expr__492(stream, pos20, ref20, context),
           {:ok, pos22, ref22, cap21} <- parse_expr__494(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__496(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__497(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__499(stream, pos24, ref24, context),
           {:ok, pos26, ref26, cap25} <- parse_expr__500(stream, pos25, ref25, context),
           {:ok, pos27, ref27, cap26} <- parse_expr__502(stream, pos26, ref26, context) do
        {:ok, pos27, ref27,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__510(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__511/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__list_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__509(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__510(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__512(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__513(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__515(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__518(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__517(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__518/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__531(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :DOT) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, DOT: {:token, :DOT, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, DOT: capture}
        :fail -> :fail
    ...
    def parse_expr__532(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__533/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__530(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__531(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__532(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__534(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__527(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__528(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__530(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__526(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__527/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__520(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__521(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__526(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__519(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__520/4, stream, pos, ref_stack, context)
    end

    def parse_rule__path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__516(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__517(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__519(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__542(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__543(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__545(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__541(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__542/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__539(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__540(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__541(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__538(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__539/4, stream, pos, ref_stack, context)
    end

    def parse_rule__combined_select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__535(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__536(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__538(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__547(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__548/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__550(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__551/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__556(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__557(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__559(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__555(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__556/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__553(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__554(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__555(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__552(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__553/4, stream, pos, ref_stack, context)
    end

    def parse_rule__bitwise_lhs(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__546(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__547(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__549(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__550(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__552(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__560/4, &parse_expr__561/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__569(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__570/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__572(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__573/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__574(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__575/4, stream, pos, ref_stack, context)
    end

    def parse_expr__577(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__576(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__577/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__qualified_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__562(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__568(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__569(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__571(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__572(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__574(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__576(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__578(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__583(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__584(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__586(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__582(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__583/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__580(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__581(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__582(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__579(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__580/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__593(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__594(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__596(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__592(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__593/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__590(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__591(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__592(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__589(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__590/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__603(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__604(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__606(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__602(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__603/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__600(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__601(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__602(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__599(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__600/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__607(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__608/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__612(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__613/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__579(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__587(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__589(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__597(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__599(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__607(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__609(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__610(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__612(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__offset_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__614(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__615(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__617(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__620(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__621/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__623(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__624/4, &parse_expr__625/4], stream, pos, ref_stack, context)
    end

    def parse_expr__622(stream, pos, ref_stack, context) do
      case (&parse_expr__623/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__618(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__619(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__620(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__622(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__633(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :KW_FOLLOWING) do
        {:ok, new_pos, text, nil} ->
          {:ok, new_pos, ref_stack, KW_FOLLOWING: {:token, :KW_FOLLOWING, text}}
    ...
    def parse_expr__631(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__632/4, &parse_expr__633/4], stream, pos, ref_stack, context)
    end

    def parse_expr__630(stream, pos, ref_stack, context) do
      case (&parse_expr__631/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__638(stream, pos, ref_stack, _context) do
    ...
    def parse_expr__634(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__635(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__636(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__638(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__618/4, &parse_expr__626/4, &parse_expr__634/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__644(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__645(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__646(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__648(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__654(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :KW_AND) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, KW_AND: {:token, :KW_AND, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, KW_AND: capture}
        :fail -> :fail
    ...
    def parse_expr__655(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__656/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__653(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__654(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__655(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__657(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__650(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__651(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__653(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__649(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__650/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__643(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__644(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__649(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__642(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__643/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__conjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__639(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__640(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__642(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__fragment_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__658/4, &parse_expr__659/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__661(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__662/4, stream, pos, ref_stack, context)
    end

    def parse_expr__660(stream, pos, ref_stack, context) do
      case (&parse_expr__661/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__663(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__664/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__negation(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__660(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__663(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__665(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__668(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__667(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__668/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__having_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__666(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__667(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__669(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__678(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__679/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__677(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__678(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__680(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__676(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__677/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__674(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__675(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__676(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__673(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__674/4, stream, pos, ref_stack, context)
    end

    def parse_rule__type_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__670(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__671(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__673(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__superset_of_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__681(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__682(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__684(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__686(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__687/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__696(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__697/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__695(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__696(stream, pos, ref_stack, context),
    ...
    def parse_expr__694(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__695/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__additive_lhs(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__685(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__686(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__688(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__689(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__691(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__with_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__699/4, &parse_expr__700/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__702(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__703/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__705(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__706/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_param(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__701(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__702(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__704(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__705(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__707(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__708(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__712(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__714(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__723(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__724/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__722(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__723(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__725(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__721(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__722/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__719(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__720(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__721(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__718(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__719/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__expression(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__715(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__716(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__718(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__731(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__730(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__731/4, stream, pos, ref_stack, context)
    end

    def parse_expr__732(stream, pos, ref_stack, _context) do
    ...
    def parse_rule__when_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__726(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__729(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__730(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__732(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__733(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__735(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__753(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__752(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__753/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__750(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__751(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__752(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__754(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__747(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__748(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__750(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__746(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__747/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__740(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__741(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__746(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__756(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__757/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__760(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__761/4, &parse_expr__762/4], stream, pos, ref_stack, context)
    end

    def parse_expr__759(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__760/4, stream, pos, ref_stack, context)
    end

    def parse_expr__758(stream, pos, ref_stack, context) do
      case (&parse_expr__759/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__order_item(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__755(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__756(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__758(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__where_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__763(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__764(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__766(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__774(stream, pos, ref_stack, _context) do
    ...
    def parse_expr__787(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__788/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__783(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__786(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__787(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__789(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__798(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__797(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__798/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__795(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__796(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__797(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__799(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__804(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__805(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__806(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__808(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__801(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__802(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__804(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__800(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__801/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__794(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__795(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__800(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__793(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__794/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__790(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__793(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__type_kind(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__809(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__810(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__812(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__820(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__821/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__subset_or_eq_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__813(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__814(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__816(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__817(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__819(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__820(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__822(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__825(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__824(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__825/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__829(stream, pos, ref_stack, context) do
      case parse_rule__path(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
          {:ok, new_pos, new_ref_stack, path: {:rule, :path, sub_captures}}
    ...
    def parse_rule__qualified_call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__823(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__824(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__826(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__827(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__829(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__832(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__831(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__832/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__838(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__837(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__838/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__835(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__836(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__837(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__839(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__842(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__843/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__844(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__845(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__846(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__848(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__841(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__842(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__844(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__840(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__841/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__834(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__835(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__840(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__833(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__834/4, stream, pos, ref_stack, context)
    end

    def parse_rule__call_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__830(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__831(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__833(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__851(stream, pos, ref_stack, _context) do
    ...
    def parse_expr__850(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__851/4, stream, pos, ref_stack, context)
    end

    def parse_expr__849(stream, pos, ref_stack, context) do
      case (&parse_expr__850/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__853(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__852(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__853/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_operand(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__849(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__852(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__854(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__855(stream, pos, ref_stack, _context) do
    ...
    def parse_expr__857(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__856(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__857/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__860(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__859(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__860/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__861(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__862/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__866(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__867/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__869(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__870/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__855(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__856(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__858(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__859(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__861(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__863(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__865(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__866(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__868(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__869(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__871(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__873(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__874/4, &parse_expr__875/4], stream, pos, ref_stack, context)
    end

    def parse_expr__872(stream, pos, ref_stack, context) do
      case (&parse_expr__873/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_expr__876(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__877/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__mult_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__872(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__876(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__878(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__880(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__881/4, &parse_expr__882/4], stream, pos, ref_stack, context)
    end

    def parse_expr__879(stream, pos, ref_stack, context) do
      case (&parse_expr__880/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_expr__884(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__883(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__884/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__additive_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__879(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__883(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__885(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__890(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__891/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__886(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__887(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__889(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__890(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__892(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__898(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__899/4, stream, pos, ref_stack, context)
    end

    def parse_expr__897(stream, pos, ref_stack, context) do
      case (&parse_expr__898/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__body_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__893(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__894(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__895(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__897(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(cap1, Parser.merge_captures(cap2, cap3))
